<?php
    session_start();
        ...
        if(isset($_POST['upd_cart'])){
            $query1 = mysqli_query($mysql, "update cart set status='$_POST[upd_status]' where cart_id='$_POST[upd_cart_id]';");
        ?>
                  ...
                  <div class="login_form">
                     <form class="fill_up" action="" method="post" role="form">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                                $query1 = mysqli_query($mysql, "select * from cart where cart_id='$id';");
                                while($row1 = mysqli_fetch_array($query1)){
                                    ?>

                           <div class="field">
                              <label class="label_field">Cart ID</label>
                              <input type="text" name="upd_cart_id" readonly value="<?php echo $row1['cart_id'];?>" />
                           </div>
                           <div class="field">
                              <label class="label_field">Status</label>
                              <input type="text" name="upd_status" value="<?php echo $row1['status'];?>" required />
                           </div>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="upd_cart" type="submit" class="btn btn-primary" value="Save" />
