                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['search_button'])) {
                                            ...
                                            while($row3 = mysqli_fetch_array($query3)) {
                                                ...
                                                <div class="col-sm-4 col-md-2 col-6 margin_bottom_30">
                                                   <div class="column">
                                                      <a href="ind_type.php?tid=<?php echo $row3['type_id'];?>&tname=<?php echo $row3['types'];?>&cid=<?php echo $row3['category_id'];?>&cname=<?php echo $row3['category'];?>"><img class="all_product" src="<?php echo "upload/".$row3['type_image'];?>" alt="#" /></a>
                                                   </div>
