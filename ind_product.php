                                    ...
                                    <div class="well-middle">
                                      <div class="single-well">
                                        ...
                                        <form action="" method="post" role="form">
                                            <a href="ind_login.php?id=<?php echo $row1['product_id'];?>&name=<?php echo $row1['name'];?>" class="btn btn-outline-primary" ><i class="fa fa-shopping-cart"></i> Add to Cart</a>
                                            <a href="ind_login.php?id=<?php echo $row1['product_id'];?>&name=<?php echo $row1['name'];?>" class="btn btn-primary" > Buy Product</a>
                                        </form>
                                      </div>
                                    </div>
                                  </div>
