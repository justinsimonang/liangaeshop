<?php
    session_start();
        ...
        if(isset($_POST['add_location'])) {
            $qry1 = mysqli_query($mysql, "select * from location where pickup='$_POST[add_pickup]' and charge='$_POST[add_charge]';");
            if (mysqli_num_rows($qry1) >= 1) {
                ...
                <?php
                echo '<meta http-equiv="refresh" content="0;url=emp_location.php" />';
            } else {
                $query1 = mysqli_query($mysql, "insert into location values('$_POST[add_location_id]','$_POST[add_pickup]','$_POST[add_charge]','$_POST[add_travel_time]');");
                $query2 = mysqli_query($mysql, "update count set location='$_POST[loc_count]';");
                ?>
                    <script type="text/javascript">
...
<head>
  ...
  <title>Lianga eShopping | Employee - Location</title>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="table_section padding_infor_info">
                                  ...
                                  <div align="center" style="margin-bottom:0px;">
                                      <button type="submit" data-toggle="modal" data-target="#add_modal" class="btn btn-primary "><i class="fa fa-plus fa-fw fa-lg"></i> Add Location</button>
                                  </div>
                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       <thead>
                                          <tr style="color:#000099; font-weight:bold;">
                                             ...
                                             <th>Location</th>
                                             <th>Charge</th>
                                             <th>Total Minutes to Travel</th>
                                             <th>Action</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                           <?php
                                                $qry2 = mysqli_query($mysql, "select * from location;");
                                          ...
                                          <tr style=" font-family:Arial Narrow;" class="odd gradeX">
                                             ...
                                             <td><?php echo $row2['travel_time']." minute/s"; ?></td>
                                             <td>
                                                <a href="emp_editlocation.php?id=<?php echo $row2['location_id'];?>">
                                                ...
                                                <!--
                                                <a onclick="return confirm('Are you sure you want to permanently delete this data?');" href="delete_data.php?id=<?php echo $row2['location_id']; ?>&name=location">
                     ...
                     <form action="" method="post" role="form">
                        <fieldset>
                            <?php
                                ...
                                $count1 = $row1['location'] + 1;
                                $add1 = 10000 + $count1;
                                $id = "LOCA-".$add1;
                            ?>
                            <input type="hidden" name="loc_count" readonly value="<?php echo $count1;?>" />
                           <div class="field">
                              <label class="label_field">Location ID</label>
                              <input type="text" name="add_location_id" readonly value="<?php echo $id;?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Location</label>
                              <input type="text" name="add_pickup" placeholder="Barangay - Pickup Location" required />
                           </div>
                           <div class="field">
                              <label class="label_field">Charge</label>
                              <input type="number" min=1 name="add_charge" placeholder="Charge Fee" required />
                           </div>
                           <div class="field">
                              <label class="label_field">Number of Minutes</label>
                              <input type="number" min=1 name="add_travel_time" placeholder="Number of Minutes to Travel" required />
                           </div>
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="add_location" type="submit" class="btn btn-primary" value="Add" />
