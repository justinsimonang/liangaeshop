                              ...
                              <div class="table_section padding_infor_info">
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                           <?php
                                                $qry2 = mysqli_query($mysql, "select * from product where supplier='$id_number';");
                                       ...
                                       <style>
                                            ...
                                            .zoom:hover {
                                             ...
                                             <td><a href="#" title="<?php echo $row2['name']; ?> "><?php echo $row2['description']; ?></a></td>
                                             ...
                                             <td align="center">
                                                 <a href="sup_stock.php?id=<?php echo $row2['product_id'];?>">
                                                ...
                                                <a href="sup_editprodcat.php?id=<?php echo $row2['product_id'];?>">
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <form action="sup_fillproduct.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="sup_product" type="submit" class="btn btn-primary" value="Next" />
