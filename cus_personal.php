<?php
    session_start();
        ...
        ?>
                ...
                <?php
                echo '<meta http-equiv="refresh" content="0;url=cus_personal.php" />';
...
<head>
  ...
  <title>Lianga eShopping | Customer - Personal Information</title>
                     ...
                     <form class="fill_up" action="" method="post" role="form">
                        <fieldset>
                           ...
                           <div class="field">
                              ...
                              <input type="text" name="upd_customer_id" value="<?php echo $row1['customer_id'];?>" readonly />
