            ...
            <div class="center verticle_center">
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form class="fill_up" action="adm_editproduct.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="upd_adm_product" type="submit" class="btn btn-primary" value="Next" />
