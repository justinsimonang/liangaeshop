                              ...
                              <div class="table_section padding_infor_info">
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                           <?php
                                                $qry2 = mysqli_query($mysql, "select *, c.date_time as date_time, c.status as cart_status from cart c, product p, customer d where c.product_id = p.product_id and c.customer_id = d.customer_id;");
                                        		while($row2 = mysqli_fetch_array($qry2))
                                        		{
        	                                ?>
                                          <tr style=" font-family:Arial Narrow;" class="odd gradeX">
                                             <td><?php echo $row2['cart_id']; ?></td>
                                             <td><a href="#" title="<?php echo $row2['name'].", ".$row2['price']; ?>"><?php echo $row2['description']; ?></a></td>
                                             <td><a href="#" title="<?php echo $row2['customer_id']; ?>"><?php echo $row2['fname']." ".$row2['lname']; ?></a></td>
                                             <td><?php echo $row2['date_time']; ?></td>
                                             <td><?php echo $row2['cart_status']; ?></td> <!--
                                             <td align="center">
                                                <a href="adm_editcart.php?id=<?php echo $row2['cart_id'];?>">
                                                ...
                                                <a onclick="return confirm('Are you sure you want to permanently delete this data?');" href="delete_data.php?id=<?php echo $row2['cart_id']; ?>&name=cart">
