...
<head>
  ...
  <title>Lianga eShopping | Admin - Location</title>
                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                          ...
                                          <tr style=" font-family:Arial Narrow;" class="odd gradeX">
                                             ...
                                             <td align="center">
                                                <a href="adm_editlocation.php?id=<?php echo $row2['location_id'];?>">
                     ...
                     <form action="" method="post" role="form">
                        <fieldset>
                           ...
                           <div class="field">
                              ...
                              <input type="number" min=0 name="add_charge" placeholder="Charge Fee" required />
                           </div>
                           <div class="field">
