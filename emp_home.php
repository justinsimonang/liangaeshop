...
<head>
  ...
  <title>Lianga eShopping | Employee - Home</title>
                                    ...
                                    <?php
                                        ...
                                        while($row3 = mysqli_fetch_array($query3)) {
                                            ...
                                            <div class="col-sm-2 col-md-2 col-4 margin_bottom_30">
                                               <div class="column">
                                                  <a href="emp_outstock.php?id=<?php echo $product_id;?>"><img class="top_product" src="<?php echo "upload/".$row3['image'];?>" title="Click to Add Stock" alt="#" /></a>
                                               </div>
