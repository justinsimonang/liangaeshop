<?php
    session_start();
        ...
        ?>
                ...
                <?php
                echo '<meta http-equiv="refresh" content="0;url=cus_result.php" />';
        }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Lianga eShopping | Search Result</title>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>Search Results for "<?php echo $_POST['product'];?>"</h2>
                                 </div>
                              </div>
                                 ...
                                 <div class="row">
                                    <?php
                                        ...
                                        if(isset($_POST['search_button'])) {
                                            ...
                                            $query3 = mysqli_query($mysql, "select *,max(sold) as max_sold, p.image as image from product p, category c, types t, monitoring m where (t.types like '%$product%' or c.category like '%$product%' or p.name like '%$product%' or p.description like '%$product%' or p.brand like '%$product%')
                                                    and p.product_id=m.product_id and p.category_id=c.category_id and p.type_id=t.type_id group by p.product_id order by m.date_time desc;");
