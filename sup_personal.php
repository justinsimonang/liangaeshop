<?php
    session_start();
        ...
        ?>
                ...
                <?php
                echo '<meta http-equiv="refresh" content="0;url=sup_personal.php" />';
...
<head>
  ...
  <title>Lianga eShopping | Supplier - Personal Information</title>
               ...
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form class="fill_up" action="" method="post" role="form">
                        <fieldset>
                           <?php
                                $query1 = mysqli_query($mysql, "select * from supplier where supplier_id='$id_number';");
                                while($row1 = mysqli_fetch_array($query1)){
                                    ?>

                           <div class="field">
                              <label class="label_field">Employee ID</label>
                              <input type="text" name="upd_supplier_id" value="<?php echo $row1['supplier_id'];?>" readonly />

                           </div>
                           <div class="field">
                              <label class="label_field">Store Name</label>
                              <input type="text" name="upd_store" value="<?php echo $row1['store'];?>" readonly />
                           </div>
                           <div class="field">
