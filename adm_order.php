<?php
    session_start();
        ...
        if(isset($_POST['add_order'])) {
            ...
            $query1 = mysqli_query($mysql, "insert into orders values('$_POST[add_order_id]',NOW(),'$_POST[add_quantity]','$_POST[add_total]','$_POST[add_charge]',
                        '$_POST[add_sum_total]','$_POST[add_location]','$_POST[add_product_id]','$_POST[add_customer_id]');");
            $query2 = mysqli_query($mysql, "update count set orders='$_POST[orde_count]';");
        ?>
