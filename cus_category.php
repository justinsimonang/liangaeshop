                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['search_button'])) {
                                            ...
                                            $query3 = mysqli_query($mysql, "select *, max(sold) as max_sold, p.image as image from product p, monitoring m, category c where (p.name like '%$product%' or p.description like '%$product%' or p.brand like '%$product%')
                                                        and (p.product_id=m.product_id and p.category_id=c.category_id) and c.category_id='$category_id' group by p.product_id order by m.date_time desc;");
                                            ...
                                            $query3 = mysqli_query($mysql, "select *,t.image as type_image from category c, types t where c.category_id=t.category_id and t.category_id='$category_id';");
                                            while($row3 = mysqli_fetch_array($query3)) {
                                                ?>
                                                <div class="col-sm-4 col-md-2 col-6 margin_bottom_30">
                                                   <div class="column">
                                                      <a href="cus_type.php?tid=<?php echo $row3['type_id'];?>&tname=<?php echo $row3['types'];?>&cid=<?php echo $row3['category_id'];?>&cname=<?php echo $row3['category'];?>"><img class="all_product" src="<?php echo "upload/".$row3['type_image'];?>" alt="#" /></a>
                                                   </div>
