                                    ...
                                    <div class="well-middle">
                                      <div class="single-well">
                                        ...
                                        <form class="fill-up" action="" method="post" role="form">
                                            ...
                                            <input type="hidden" name="description" id="description" readonly value="<?php echo $description;?>" />
...
<!-- The Modal -->
  ...
  <!-- jQuery -->
    ...
    function buyProduct(){
        ...
        var link = 'cus_buy.php?product_id=' + product_id + '&quantity=' + quantity + '&description=' + description;
