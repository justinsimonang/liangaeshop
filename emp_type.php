...
<head>
  ...
  <title>Lianga eShopping | Employee - Category Types</title>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="table_section padding_infor_info">
                                  ...
                                  <div align="center" style="margin-bottom:0px;">
                                      <button type="submit" data-toggle="modal" data-target="#add_modal" class="btn btn-primary "><i class="fa fa-plus fa-fw fa-lg"></i> Add Type</button>
                                  </div>
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                           <?php
                                                $qry2 = mysqli_query($mysql, "select *, t.image as type_image from category c, types t where c.category_id=t.category_id and t.category_id='$category_id';");
                                       ...
                                       <style>
                                            ...
                                            .zoom:hover {
                                             ...
                                             <td><?php echo $row2['type_id']; ?></td>
                                             <td><a href="#" title="<?php echo $row2['category_id']; ?>"><?php echo $row2['category'];?></a></td>
                                             <td><?php echo $row2['types']; ?></td>
                                             <td><img class="zoom" src="<?php echo "upload/".$row2['type_image'];?>"> </td>
                                             <td>
                                                <a href="emp_edittype.php?typeid=<?php echo $row2['type_id'];?>&id=<?php echo $row2['category_id'];?>&name=<?php echo $row2['category'];?>">
                     ...
                     <form action="add_data.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                            <?php
                                ...
                                $id = "TYPE-".$add;
                            ?>
                            <input type="hidden" name="type_count" readonly value="<?php echo $count;?>" />
                            <input type="hidden" name="category_id" readonly value="<?php echo $category_id;?>" />
                            <input type="hidden" name="category" readonly value="<?php echo $category;?>" />
                           <div class="field">
                              <label class="label_field">Type ID</label>
                              <input type="text" name="add_type_id" readonly value="<?php echo $id;?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Type</label>
                              <input type="text" name="add_type" placeholder="Category Type" required />
                           </div>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="emp_type" type="submit" class="btn btn-primary" value="Add" />
