<?php
    session_start();
        ...
        if(isset($_POST['add_employee'])) {
            $qry1 = mysqli_query($mysql, "select *,u.user_id as user_id from employee c, users u, users_employee uc where c.employee_id = uc.employee_id and
            ...
            if (mysqli_num_rows($qry1) >= 1) {
                ...
                $query1 = mysqli_query($mysql, "insert into employee values('$_POST[add_employee_id]','$_POST[add_position]','$_POST[add_lname]',
                ...
                $query2 = mysqli_query($mysql, "insert into users values('$_POST[user_id]','$_POST[username]','$_POST[password]','employee',NOW());");
                $query3 = mysqli_query($mysql, "insert into users_employee values('$_POST[user_id]','$_POST[add_employee_id]');");
                $query4 = mysqli_query($mysql, "update count set employee='$_POST[emp_count]',user='$_POST[user_count]';");
        ?>
                    <script type="text/javascript">
...
<head>
  ...
  <title>Lianga eShopping | Admin - Employee</title>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="table_section padding_infor_info">
                                  ...
                                  <div align="center" style="margin-bottom:0px;">
                                      <button type="submit" data-toggle="modal" data-target="#add_modal" class="btn btn-primary "><i class="fa fa-plus fa-fw fa-lg"></i> Add Employee</button>
                                  </div>
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                           <?php
                                                $qry2 = mysqli_query($mysql, "select * from employee;");
                                          ...
                                          <tr style=" font-family:Arial Narrow;" class="odd gradeX">
                                             ...
                                             <td>
                                                <a href="adm_editemployee.php?id=<?php echo $row2['employee_id'];?>">
                                                ...
                                                <!--
                                                <a onclick="return confirm('Are you sure you want to permanently delete this data?');" href="delete_data.php?id=<?php echo $row2['employee_id']; ?>&name=employee">
                     ...
                     <form action="" method="post" role="form">
                        <fieldset>
                            <?php
                                ...
                                $user_id = "USER-".$add2;
                            ?>
                            <input type="hidden" name="emp_count" readonly value="<?php echo $count1;?>" />
                           ...
                           <div class="field">
                              ...
                              <input type="text" name="add_employee_id" readonly value="<?php echo $id;?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Position</label>
                              <input type="text" name="add_position" placeholder="Position" required />
                           </div>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="add_employee" type="submit" class="btn btn-primary" value="Add" />
