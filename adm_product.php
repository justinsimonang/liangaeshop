                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <style>
                                            ...
                                            .zoom:hover {
                                             ...
                                             <td align="center">
                                                 <a href="adm_stock.php?id=<?php echo $row2['product_id'];?>">
                                                ...
                                                <a href="adm_editprodcat.php?id=<?php echo $row2['product_id'];?>">
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <form action="adm_fillproduct.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="adm_product" type="submit" class="btn btn-primary" value="Next" />
