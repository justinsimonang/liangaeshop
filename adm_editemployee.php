                  ...
                  <div class="login_form">
                     <form class="fill_up" action="" method="post" role="form">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                                $query1 = mysqli_query($mysql, "select * from employee where employee_id='$id';");
                           ...
                           <div align="center">
                              ...
                              <a style="margin:20px 40px 20px 40px;;" href="adm_employee.php" class="btn btn-danger">Cancel</a>
                           </div>
                           <?php
                                }
                           ?>
