<?php
    session_start();
        ...
        ?>
            ...
            $query1 = mysqli_query($mysql, "insert into orders values('$_POST[ord_id]',NOW(),'$_POST[quantity]','$_POST[total_price]','$_POST[charge]','$_POST[total_payment]','For Review','$_POST[product_id]','$id_number','$_POST[location_id]');");
            $query2 = mysqli_query($mysql, "insert into cart_orders values('$cart_id','$_POST[ord_id]','$id_number','$_POST[product_id]','$_POST[location_id]');");
            ...
            $query7 = mysqli_query($mysql, "update cart set status='bought' where cart_id='$cart_id';");
             ?>
                <script>alert("Product successfully ordered.");</script>
                <?php
                                    ...
                                    <div class="well-middle">
                                      <div class="single-well">
                                        ...
                                        <form class="fill_up" action="" method="post" role="form" align="center">
                                            ...
                                            <button type="submit" name="buy_product" class="btn btn-primary" >Buy Product</button>
                                            </fieldset>
                                        </form>
                                      </div>
                                    </div>
