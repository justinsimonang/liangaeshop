...
<head>
  ...
  <title>Lianga eShopping | Admin - Category</title>
                  ...
                  <div class="login_form">
                     <form class="fill_up" action="update_data.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                                $query1 = mysqli_query($mysql, "select * from category where category_id='$id';");
                                while($row1 = mysqli_fetch_array($query1)){
                                    ?>

                           <div class="field">
                              <label class="label_field">Category ID</label>
                              <input type="text" name="upd_category_id" readonly value="<?php echo $row1['category_id'];?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Category</label>
                              <input type="text" name="upd_category" value="<?php echo $row1['category'];?>" required />
                           </div>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="upd_adm_category" type="submit" class="btn btn-primary" value="Save" />
                              <a style="margin:20px 40px 20px 40px;;" href="adm_category.php" class="btn btn-danger">Cancel</a>
                           </div>
                           <?php
                                }
                           ?>
