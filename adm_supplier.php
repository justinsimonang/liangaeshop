<?php
    session_start();
        ...
        if(isset($_POST['add_supplier'])) {
            $qry1 = mysqli_query($mysql, "select *,u.user_id as user_id from supplier c, users u, users_supplier uc where c.supplier_id = uc.supplier_id and
...
<head>
  ...
  <title>Lianga eShopping | Admin - Supplier</title>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="table_section padding_infor_info">
                                  ...
                                  <div align="center" style="margin-bottom:0px;">
                                      <button type="submit" data-toggle="modal" data-target="#add_modal" class="btn btn-primary "><i class="fa fa-plus fa-fw fa-lg"></i> Add Supplier</button>
                                  </div>
                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <tbody>
                                          ...
                                          <tr style=" font-family:Arial Narrow;" class="odd gradeX">
                                             ...
                                             <td>
                                                <a href="adm_editsupplier.php?id=<?php echo $row2['supplier_id'];?>">
                                                ...
                                                <!--
                                                <a onclick="return confirm('Are you sure you want to permanently delete this data?');" href="delete_data.php?id=<?php echo $row2['supplier_id']; ?>&name=supplier">
                     ...
                     <form action="" method="post" role="form">
                        <fieldset>
                            <?php
                                ...
                                $user_id = "USER-".$add2;
                            ?>
                            <input type="hidden" name="sup_count" readonly value="<?php echo $count1;?>" />
                           ...
                           <div class="field">
                              ...
                              <input type="text" name="add_supplier_id" readonly value="<?php echo $id;?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Store</label>
                              <input type="text" name="add_store" placeholder="Store Name" required />
                           </div>
                           <div class="field">
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="add_supplier" type="submit" class="btn btn-primary" value="Add" />
