                  ...
                  <div class="login_form">
                     <form class="fill_up" action="" method="post" role="form">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                                $query1 = mysqli_query($mysql, "select * from users where user_id='$id';");
                                while($row1 = mysqli_fetch_array($query1)){
                                    ?>

                           <div class="field">
                              <label class="label_field">User ID</label>
                              <input type="text" name="user_id" readonly value="<?php echo $row1['user_id'];?>" />

                           </div>
                           <div class="field">
                              <label class="label_field">Username</label>
                              <input type="text" name="username" value="<?php echo $row1['username'];?>" required />
                           </div>
                           <div class="field">
                              <label class="label_field">Password</label>
                              <input type="password" name="password" value="<?php echo $row1['password'];?>" required />
                           </div>
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="upd_users" type="submit" class="btn btn-primary" value="Save" />
                              <a style="margin:20px 40px 20px 40px;;" href="adm_users.php" class="btn btn-danger">Cancel</a>
                           </div>
                           <?php
                                }
                           ?>
