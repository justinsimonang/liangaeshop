                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                       ...
                                       <style>
                                            ...
                                            .zoom:hover {
                                             ...
                                             <td align="center">
                                                 <a href="adm_type.php?id=<?php echo $row2['category_id'];?>&name=<?php echo $row2['category'];?>">
                                                ...
                                                <a href="adm_editcategory.php?id=<?php echo $row2['category_id'];?>">
                  ...
                  <div class="modal-body">
                     ...
                     <form action="add_data.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           ...
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="adm_category" type="submit" class="btn btn-primary" value="Add" />
