<?php
    session_start();
        ...
        ?>
                ...
                <?php
                echo '<meta http-equiv="refresh" content="0;url=sup_editproduct.php" />';
        }
?>
...
<head>
  ...
  <title>Lianga eShopping | Supplier - Product</title>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="sup_product.php">Product</a></li>
            ...
            <div class="center verticle_center">
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form class="fill_up" action="sup_editproduct.php" method="post" role="form" enctype="multipart/form-data">
                        <fieldset>
                           <?php
                                $id = $_GET['id'];
                           ...
                           <div class="field">
                              ...
                              <input type="text" name="product_id" readonly value="<?php echo $row1['product_id'];?>" />
                           ...
                           <div class="field">
                              ...
                              <select name="category_id" style="height:30px;">
                                 <?php
                                    $qry5 = mysqli_query($mysql, "select * from category where category_id='$row1[category_id]';");
                                    while($row5 = mysqli_fetch_array($qry5)) { ?>
                                 <option value="<?php echo $row5['category_id']?>" selected hidden><?php echo $row5['category'];?></option>
                                  <?php } ?>

                                  <?php
                                    $qry6 = mysqli_query($mysql, "select * from category;");
                                    while($row6 = mysqli_fetch_array($qry6)) { ?>
                                 <option value="<?php echo $row6['category_id']?>"><?php echo $row6['category'];?></option>
                                  <?php } ?>
                              </select>
                           </div>
                           <div align="center">
                              <input style="margin:20px 40px 20px 40px;" name="upd_sup_product" type="submit" class="btn btn-primary" value="Next" />
                              <a style="margin:20px 40px 20px 40px;;" href="sup_product.php" class="btn btn-danger">Cancel</a>
                           </div>
                           <?php
                                }
                           ?>
